...
abstract class $PaginatedResponseCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({int? total, int? skip, int? limit, List<T>? products});
}
...
class _$PaginatedResponseImpl<T> implements _PaginatedResponse<T> {
  const _$PaginatedResponseImpl(
      {this.total, this.skip, this.limit, final List<T>? products})
      : _products = products;
  ...
  @override
  String toString() {
    return 'PaginatedResponse<$T>(total: $total, skip: $skip, limit: $limit, products: $products)';
  }
...
abstract class _PaginatedResponse<T> implements PaginatedResponse<T> {
  const factory _PaginatedResponse(
      ...
      final int? skip,
      final int? limit,
      final List<T>? products}) = _$PaginatedResponseImpl<T>;
